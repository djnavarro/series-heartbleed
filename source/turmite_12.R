...
sourceCpp(here::here("turmite_b.cpp"))

filename <- here::here("turmite_12.png")
grain <- 1000
pixels <- 5000
nsteps <- 50000000
ncols <- 1000
...
#palette <- c(col2hex("ghostwhite"), scico::scico(ncols, palette = "batlow"))
palette <- scico::scico(ncols + 1, palette = "batlow")
