...
output <- here::here("turmite_51.png")
set.seed(502)
...
palette <- f(ncols + 1)
palette <- paletteer::paletteer_c("grDevices::Green-Brown", ncols + 1)
...
palette_heart <- paletteer::paletteer_c("grDevices::Green-Brown", ncols + 1)
